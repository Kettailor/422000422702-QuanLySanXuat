...
<nav class="sidebar">
    ...
    <div class="nav-group">
        <a class="nav-link <?= in_array($currentController, ['quality', 'dotxuat']) ? 'active' : '' ?>" data-bs-toggle="collapse" href="#submenu-quality" role="button" aria-expanded="false" aria-controls="submenu-quality">
            <i class="bi bi-shield-check"></i> Chất lượng
        </a>
        <div class="collapse <?= in_array($currentController, ['quality', 'dotxuat']) ? 'show' : '' ?>" id="submenu-quality">
            <ul class="btn-toggle-nav list-unstyled fw-normal small ms-3">
                <li>
                    <a class="nav-link <?= $currentController === 'quality' ? 'active' : '' ?>" href="?controller=quality&action=index">
                        <i class="bi bi-clipboard-data"></i> Đánh giá thành phẩm
                    </a>
                </li>
                <li>
                    <a class="nav-link <?= $currentController === 'dotxuat' ? 'active' : '' ?>" href="?controller=dotxuat&action=index">
                        <i class="bi bi-exclamation-octagon"></i> Kiểm tra đột xuất
                    </a>
                </li>
            </ul>
        </div>
