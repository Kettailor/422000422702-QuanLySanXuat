                ...
                <div class="col-xl-4 col-md-6">
                    <div class="summary-card h-100">
                        <div class="d-flex justify-content-between align-items-start mb-3 gap-3">
                            ...
                            <?php if ($form): ?>
                                <a class="btn btn-sm btn-outline-primary" href="?controller=warehouse_sheet&action=create&direction=inbound&category=<?= urlencode($typeKey) ?>">
    ...
    <section class="warehouse-section" id="warehouse-group-<?= htmlspecialchars($typeKey) ?>">
        <div class="group-card">
            <div class="group-header">
                ...
                <?php if ($form): ?>
                    <div class="d-flex gap-2 flex-wrap">
                        <a class="btn btn-success" href="?controller=warehouse_sheet&action=create&direction=inbound&category=<?= urlencode($typeKey) ?>">
                            <i class="bi bi-plus-lg me-2"></i><?= htmlspecialchars($form['submit_label']) ?>
                        </a>
                        <?php if (!empty($outboundDocumentTypes[$typeKey])): ?>
                            <a class="btn btn-outline-danger" href="?controller=warehouse_sheet&action=create&direction=outbound&category=<?= urlencode($typeKey) ?>">
