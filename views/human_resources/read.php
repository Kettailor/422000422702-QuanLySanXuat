        ...
        <div class="row align-items-center g-3">
            ...
            <div class="col-md-4 text-md-end">
                <div class="d-flex flex-wrap gap-2 justify-content-md-end">
                    <a href="?controller=salary&action=index" class="btn btn-outline-info"><i class="bi bi-cash-stack me-1"></i>Lương thưởng</a>
                    <a href="?controller=timekeeping&action=index" class="btn btn-outline-secondary"><i class="bi bi-calendar-check me-1"></i>Chấm công</a>
                    <a href="?controller=plan&action=index" class="btn btn-outline-primary"><i class="bi bi-diagram-3 me-1"></i>Kế hoạch</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-4">
            <div class="card h-100 p-4">
                ...
                <a href="?controller=salary&action=index" class="btn btn-sm btn-outline-info mt-3">Xem bảng lương</a>
            </div>
        </div>
    </div>
        ...
        <div class="row g-4">
            <div class="col-md-6">
                ...
                <div class="list-group">
                    <a href="?controller=timekeeping&action=index" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                        <div>
                    ...
                    <a href="?controller=plan&action=index" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                        <div>
                    ...
                    <a href="?controller=salary&action=index" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                        <div>
